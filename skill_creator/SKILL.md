---
name: skill_creator
description: The mandatory tool for creating new Agent Skills. Use this whenever the user asks to create, add, or build a new skill. (e.g., "create a skill", "スキルを作って")
---
