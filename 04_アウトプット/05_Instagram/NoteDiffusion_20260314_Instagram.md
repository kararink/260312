# NoteDiffusion Instagram Images - 20260314

## 生成済み画像

### 1枚目 (フック)
![1枚目](NoteDiffusion_20260314_IG_01.png)
**再生成用プロンプト**: Instagram slide 1 of 3, dark navy background (#1A1A2E) with gold accent lines. Large bold white Japanese text in the center reading "残業すると手取りが減る？". Below in smaller white text: "年収130万円の壁、4月から変わる". Clean minimal modern design, square 1:1 format, social media graphic style. Japanese typography, professional infographic.

### 2枚目 (解説)
![2枚目](NoteDiffusion_20260314_IG_02.png)
